 ...
 * Se genera una señal cuadrada por la línea RE0 con un periodo (T) de 2 seg y
...
void main(void)
{
    ...
    while(1)    //Bucle infinito
    {
        ...
        __delay_ms(1000);      	//Función para temporizaciones en ms, se pide un retardo de 1000ms = 1seg
    }
}
...
void SetUp(void)
{
    ...
    OSCCONbits.IRCF = 0b111;    //Fosc = 16 Mhz del oscilador interno
